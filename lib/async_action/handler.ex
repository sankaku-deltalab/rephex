  ...
  defmacro __using__(_opt \\ []) do
    quote do
      ...
      def handle_info(
        ...
        {:noreply,
         Rephex.AsyncAction.Backend.update_progress(socket, action_module, result_path, progress)}
      end
      ...
      def handle_async(
          ...
          when is_atom(action_module) and is_list(result_path) do
        {:noreply, Rephex.AsyncAction.Backend.resolve(socket, action_module, result_path, result)}
      end
    end
  end
end
